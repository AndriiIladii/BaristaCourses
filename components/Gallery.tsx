        ...
        <section id="Gallery" className="py-24 scroll-mt-20 bg-[#faf9f7]">
            <div className="container mx-auto px-4">
                ...
                <div className="gallery-grid">
                    <div className="photo-card md:[grid-row:1/3] grid-auto"><img src="gallery/gallery-1.png" alt="Latte art — серце" className="photo-card-img w-full h-full object-cover" />
                    ...
                    <div className="photo-card"><img src="gallery/gallery-2.png" alt="Бариста наливає молоко" className="photo-card-img w-full h-full object-cover" />
                        <div className="photo-card-overlay flex items-end p-[1.25rem] absolute opacity-0 inset-0">
                            <span className="text-sm px-3 py-1 rounded-full photo-card-span">Milk Pour</span>
                        </div></div>
                    <div className="photo-card"><img src="gallery/gallery-3.png" alt="Latte art — тюльпан" className="photo-card-img w-full h-full object-cover" />
                        <div className="photo-card-overlay flex items-end p-[1.25rem] absolute opacity-0 inset-0">
                            <span className="text-sm px-3 py-1 rounded-full photo-card-span">Tulip</span>
                        </div></div>
                    <div className="photo-card md:[grid-column:2/4] col-auto"><img src="gallery/gallery-4.png" alt="Кавові зерна спешелті" className="photo-card-img w-full h-full object-cover" />
                        <div className="photo-card-overlay flex items-end p-[1.25rem] absolute opacity-0 inset-0">
