...
const BenefitsCard = ({ benefit, index }: BenefitCardProps) => {
    ...
    return (
        <div className="relative overflow-hidden rounded-2xl p-8 group border-[1.5] border-brown-50 bg-surface benefit-card">
            <span className="absolute -top-4 right-4 select-none pointer-events-none font-secondary text-[9rem] font-black text-brown-50 leading-[1] benefit-span">{String(index + 1).padStart(2, '0')}</span>
