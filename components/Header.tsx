...
const Header = () => {
    return (
        <header className="flex flex-col md:flex-row min-h-screen">
            <div className="md:hidden h-[50vh] relative overflow-hidden bg-brown">
                <img src="/header.png" alt="Бариста за роботою" className="w-full h-full object-cover object-center opacity-85" />
                <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 50%, rgba(250,249,247,0.6) 100%)" }}></div>
            </div>
            <div className="flex-1 flex flex-col justify-center px-6 md:px-14 lg:px-20 pt-10 md:pt-36 pb-14 md:pb-20 bg-[#faf9f7]">
                <div className="max-w-xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-14">
                        <button className="flex items-center justify-center gap-2 px-8 py-4 rounded-full cursor-pointer text-base bg-brown text-[#d7ccc8] transform-none button-first">Записатись на курс <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-right w-4 h-4"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></button>
                        <button className="flex items-center justify-center gap-2 px-8 py-4 rounded-full cursor-pointer text-base bg-transparent text-[rgb(109,76,65)] cursor-pointer button-second">Переглянути тарифи</button>
                    </div>
                    <div className="flex gap-8 pt-8 border-t border-[#e8e0de]">
                        <div>
            ...
            <div className="hidden md:block relative bg-brown w-[44%]">
                <img src="/header.png" alt="Бариста за роботою" className="absolute inset-0 w-full h-full object-cover opacity-75" />
