...
const ContactSidebar = () => {
    return (
        <div className="md:col-span-2 p-8 md:p-12 flex flex-col justify-between relative overflow-hidden bg-brown">
            <div className="absolute -bottom-8 -right-6 select-none pointer-events-none font-secondary text-[10rem] font-black text-[rgba(255,255,255,0.04)] leading-none">&#x2615;&#xFE0E;</div>
            <div>
