...
export const benefits: Benefit[] = [
  {
    ...
    icon: "/BaristaCourses/benefits-icons/benefit-1.svg",
    alt: "Іконка переваг",
  },

  {
    ...
    icon: "/BaristaCourses/benefits-icons/benefit-2.svg",
    alt: "Іконка переваг",
  },
  {
    id: "pro-knowledge",
    ...
    icon: "/BaristaCourses/benefits-icons/benefit-3.svg",
    alt: "Іконка переваг",
  },
  {
    id: "service",
    ...
    icon: "/BaristaCourses/benefits-icons/benefit-4.svg",
    alt: "Іконка переваг",
  },
];
